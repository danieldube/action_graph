...
#ifndef SRC_NATIVE_CONFIGURATION_INCLUDE_NATIVE_CONFIGURATION_SCALAR_NODE_H_
#define SRC_NATIVE_CONFIGURATION_INCLUDE_NATIVE_CONFIGURATION_SCALAR_NODE_H_
...
#endif // SRC_NATIVE_CONFIGURATION_INCLUDE_NATIVE_CONFIGURATION_SCALAR_NODE_H_
